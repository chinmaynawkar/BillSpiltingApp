...
class CalculatorViewController: UIViewController {
    ...
    //creating IBOutlets for all the fields present on the mainscreen
    ...
    var tip = 0.10
    var numberOfPeople = 2 // inital value to spilt the bill
    var billTotal = 0.0
    var finalResult = "0.0"
    
    //creating IBActions to get input of Actions performed by the User
    @IBAction func tipChanged(_ sender: UIButton) {
        
        //Dismiss the keyboard when the user chooses one of the tip values.
        billTextField.endEditing(true)
        
        //the user pressed button become the selected button and make the others deselected.
        ...
        //droplast drops the last letter of the string
